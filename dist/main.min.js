...
var _interopRequireDefault = __webpack_require__(309);

var _regenerator = _interopRequireDefault(__webpack_require__(310));

var _asyncToGenerator2 = _interopRequireDefault(__webpack_require__(311));
...
var dialog = {
  ...
  show: function show(type) {
    ...
    this.lock = true;
    $(".mask").addClass("on");
    $(".".concat(type)).addClass("on zoomIn");
  }
};
var commonFunc = {
  bgParallax: function bgParallax(scrollTop) {
    if (scrollTop <= $(".bg-4").offset().top) {
      return;
    }

    var scrollDistance = scrollTop - $(".bg-4").offset().top;
  ...
  tectosomeEnter: function tectosomeEnter(index) {
    var arr = [0, 1, 2, 3, 4];
    arr.forEach(function (item) {
      if (item < index) {
        $(".s2-tectosomeContainer li").eq(item).find(".s2-tectosomeContent").addClass("hover-right");
      } else if (item > index) {
        $(".s2-tectosomeContainer li").eq(item).find(".s2-tectosomeContent").addClass("hover-left");
      } else {
        $(".s2-tectosomeContainer li").eq(item).find(".s2-tectosomeContent").addClass("hover-active");
        $(".s2-tectosomeContainer li").eq(item).find(".name").addClass("nameAniClass");
      }
    });
  },
  tectosomeLeave: function tectosomeLeave(index) {
    var arr = [0, 1, 2, 3, 4];
    arr.forEach(function (item) {
      if (item < index) {
        $(".s2-tectosomeContainer li").eq(item).find(".s2-tectosomeContent").removeClass("hover-right");
      } else if (item > index) {
        $(".s2-tectosomeContainer li").eq(item).find(".s2-tectosomeContent").removeClass("hover-left");
      } else {
        $(".s2-tectosomeContainer li").eq(item).find(".s2-tectosomeContent").removeClass("hover-active");
        $(".s2-tectosomeContainer li").eq(item).find(".name").removeClass("nameAniClass");
      }
    });
  },
  ...
  preNumShow: function preNumShow(count) {
    count = count.toString();
    var countLen = count.length;

    if (countLen < 6) {
      for (var i = 0; i < 6 - countLen; i++) {
        count = "0" + count;
      }
    }
    ...
    for (var _i = 0; _i < countArr.length; _i++) {
      countArr[_i] = "num" + countArr[_i];
    }

    [].slice.call($(".s1-num")).forEach(function (item, index) {
      $(item).removeClass(function (index, oldclass) {
  ...
  preNumAni: function preNumAni(finalNum, totalTime, speed) {
    var _this3 = this;

    var curNum = 0;
    var addNum = Math.ceil(finalNum / (totalTime / speed));
...
var axiosFunc = {
  login: function () {
    var _login = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(isShare, mail, from_uid) {
      var res;
  ...
  getShareLink: function () {
    var _getShareLink = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2() {
      var res, invite_link;
      return _regenerator["default"].wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return $axios.post("/yuyue/sharelink");
            ...
            case 2:
              ...
              if (res.code == 0) {
                isShare = true;
                invite_link = location.origin + location.pathname + "?from_uid=" + res.data.from_uid;
  ...
  getPreCount: function () {
    var _getPreCount = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee3() {
      var res, preNumArr, preCount, i;
      return _regenerator["default"].wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return $axios.post("/yuyue/count");
            ...
            case 2:
              ...
              preNumArr = [0, 5, 10, 20, 30, 50];
              preCount = Math.floor(res.data.num / 10000);
              i = preNumArr.length - 1;
            ...
            case 7:
              ...
              $(".s3-progress-0, .s3-progress-1").addClass("reached-".concat(preNumArr[i], "w"));
            ...
            case 14:
              preNumArr.forEach(function (item, index) {
                if (index != 0) {
                  if (preCount >= item) {
                    $(".s3-reward").eq(index - 1).addClass("reached");
                  }
                }
              });
              preorderCount = res.data.num > 999999 ? 999999 : res.data.num;
              return _context3.abrupt("return", preorderCount);
    ...
    function getPreCount() {
      return _getPreCount.apply(this, arguments);
    }

    return getPreCount;
  }(),
  pv: function () {
    var _pv = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee4(from_uid) {
      var res;
...
$(function () {
  ...
  var mail = "";
  var from_uid = commonFunc.getQueryString("from_uid") || 0;
  ...
  $(".dialog-mail .dialog-close, .dialog-comfirm .dialog-close").click(function () {
    isShare = false;
  }); // 分享

  $(".share-twshare").click(function () {
    var twTitle = "超爽快本格3DアクションRPG『パニシング：グレイレイヴン』事前登録受付中！戦友とともに、人類の終焉に立ち向かう旅へ踏み出そう！iPhone 11 Pro Maxや公式グッズがもらえる抽選キャンペーン好評開催中！今すぐ予約しよう！ #パニグレ #事前登録 #戦友招待キャンペーン ";
    var twUrl;
    ...
    var shareURL = "http://twitter.com/intent/tweet?text=".concat(encodeURIComponent(twTitle)).concat(encodeURIComponent(twUrl)); // window.location.href = shareURL;

    window.open(shareURL);
  });
  $(".sidebar-licia").click(function () {
    var twTitle = "超爽快本格3DアクションRPG『パニシング：グレイレイヴン』事前登録受付中！今すぐ予約すると、リリース後にSクラス構造体、限定塗装や意識など、豪華な報酬がもらえる！さらに戦友招待キャンペーンに参加してiPhone 11 Pro Maxやグッズをゲットしよう！#パニグレ #事前登録 ";
    var twUrl = location.origin + location.pathname;
    var shareURL = "http://twitter.com/intent/tweet?text=".concat(encodeURIComponent(twTitle)).concat(encodeURIComponent(twUrl)); // window.location.href = shareURL;
  ...
  var parallaxInstance = new Parallax(scene); // 视差背景
  ...
  $(".nav-rightbar-bg, .nav-switch").click(function () {
    if ($(".nav-switch").hasClass("cur")) {
      $(".nav-switch,.sidebar-nav, .nav-line, .nav-logo, .sidebar-nav ul li,.nav-goHome ").removeClass("cur");
    } else {
      $(".nav-switch,.sidebar-nav, .nav-line, .nav-logo, .sidebar-nav ul li,.nav-goHome ").addClass("cur");
    }
  });
  $(".sidebar-nav ul li").click(function () {
    var index = Number($(this).index());
    var targetArr = $(".target").toArray();
    var distance = Math.floor($(targetArr[index]).offset().top - 10);
    $("body,html").animate({
      scrollTop: distance
    }, 500);
  }); // 构造体交互

  $(".s2-move li").hover(function (param) {
    var index = Number($(this).index());

    if ($(".s2-tectosomeContainer li").eq(index).hasClass("select") || $(".s2-tectosomeContainer li").eq(index).hasClass("noselect")) {
      return false;
    }
  ...
  $(".s2-move li").click(function (event) {
    ...
    commonFunc.tectosomeLeave(index);
    $(".s2-tectosomeContainer li").eq(index).addClass("select").siblings().addClass("noselect");
    $(".s2-tectosomeContainer li").eq(index).find(".teamlogo").removeClass("fadeOutUp").show().addClass("fadeInDown");
    $(".s2-tectosomeContainer li").eq(index).find(".introduction").removeClass("fadeOutRight").show().addClass("fadeInLeft");
    $(".s2-tectosomeContainer li").eq(index).find(".cvslogan").removeClass("flipOutY").show().addClass("flipInY");
  });
  $(".s2-tectosomeContainer li .s2-close").click(function (event) {
    var _this = $(".select");

    $(".select").find(".teamlogo").removeClass("fadeInDown").addClass("fadeOutUp");
    $(".select").find(".introduction").removeClass("fadeInLeft").addClass("fadeOutRight");
  ...
  var timeLine = '<a class="twitter-timeline" data-lang="ja" data-width="100%" data-height="100%" data-chrome="noheader noborders noscrollbar transparent" href="https://twitter.com/punigray_staff">Tweets by LastElysion_pr</a>';
  $(".s6-tw").html(timeLine); // 回到顶部

  $(".footer-gotop").click(function () {
    $(".footer-gotop-heart").addClass("gotopAni").find("img").addClass("floatAni");
    $("body,html").animate({
      scrollTop: 0
    }, 500, "linear", function () {
      $(".footer-gotop-heart").removeClass("gotopAni").find("img").removeClass("floatAni");
    });
  }); // 弹窗 - wv

  $(".s5-wv").click(function () {
    var index = Number($(this).attr("data-id"));
    dialog.show("dialog-wv".concat(index));
  }); // 弹窗 - 关闭
